...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_empty_input_should_fail() {
    let input = array![];

    let res = RLPTrait64::encode_64(input.span());
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_default_value() {
    let input = RLPItem64::String(array![].span());

    let res = RLPTrait64::encode_64(array![input].span()).unwrap();
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_string_single_byte_lt_0x80() {
    let mut input: Array<u64> = Default::default();
    input.append(0x40);

    let res = RLPTrait64::encode_64(array![RLPItem64::String(input.span())].span()).unwrap();
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_string_single_byte_ge_0x80() {
    let mut input: Array<u64> = Default::default();
    input.append(0x80);
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_string_length_between_2_and_55() {
    let mut input: Array<u64> = Default::default();
    input.append(0x40);
    input.append(0x50);
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_string_length_exactly_56() {
    let mut input: Array<u64> = Default::default();
    let mut i = 0;
    while (i != 56) {
        input.append(0x60);
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_string_length_greater_than_56() {
    let mut input: Array<u64> = Default::default();
    let mut i = 0;
    while (i != 60) {
        input.append(0x70);
...
#[test]
#[available_gas(200000000)]
fn test_rlp64_encode_string_large_bytearray_inputs() {
    let mut input: Array<u64> = Default::default();
    let mut i = 0;
    while (i != 500) {
        input.append(0x70);
...
#[test]
#[available_gas(20000000)]
fn test_rlp64_encode_mutilple_string() {
    let mut input = array![];
    input.append(RLPItem64::String(array![0x40, 0x53, 0x15, 0x94, 0x50, 0x40, 0x40, 0x40].span()));
    input.append(RLPItem64::String(array![0x03].span()));

    let res = RLPTrait64::encode_64(input.span()).unwrap();
...
#[test]
#[available_gas(99999999999)]
fn test_rlp64_encode_short_list() {
    let string_0 = RLPItem64::String(array![0x35, 0x35, 0x35].span());
    let string_1 = RLPItem64::String(array![0x42].span());
    let string_2 = RLPItem64::String(array![0x45, 0x38, 0x92].span());

    let list = RLPItem64::List(array![string_0, string_1, string_2].span());
    let res = RLPTrait64::encode_64(array![list].span()).unwrap();
...
#[test]
#[available_gas(99999999999)]
fn test_rlp64_encode_short_nested_list() {
    let string_0 = RLPItem64::List(array![].span());
    let string_1 = RLPItem64::List(array![string_0].span());
    let string_2 = RLPItem64::List(array![string_0, string_1].span());
...
#[test]
#[available_gas(99999999999)]
fn test_rlp64_encode_long_list() {
    let string_0 = RLPItem64::String(
        array![
            0x77,
            0x70,
            0xcf,
    ...
    let string_10 = RLPItem64::String(
        array![
            0x20,
            0xb0,
            0x68,
    ...
    let string_11 = RLPItem64::String(
        array![
            0x8e,
            0xed,
            0xeb,
    ...
    let string_12 = RLPItem64::String(
        array![
            0x79,
            0x23,
            0xa3,
    ...
    let string_13 = RLPItem64::String(
        array![
            0x65,
            0x34,
            0xd7,
    ...
    let string_14 = RLPItem64::String(
        array![
            0xbf,
            0xf9,
            0xc2,
    ...
    let string_15 = RLPItem64::String(
        array![
            0x7f,
            0x14,
            0x61,
    ...
    let string_16 = RLPItem64::String(array![].span());
    ...
    let list = RLPItem64::List(strings_list.span());
